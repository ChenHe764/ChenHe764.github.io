...
- A Unified Framework for Iterate Convergence of Bregman Proximal Methods  <br> He Chen, Jiaming Fan, Anthony Man-Cho So.<br>
*Preprint* [[arxiv]](https://arxiv.org/abs/2608.05536)  <br>
- On the Iterate Convergence of Bregman Projected Gradient Method  <br> He Chen, Anthony Man-Cho So.<br>
*Revision* at **Mathematical Programming** [[arxiv]](https://arxiv.org/abs/2608.05035) <br>
- Spurious Stationarity and Hardness Results for Bregman Proximal-Type Algorithms <br> He Chen, Jiajin Li, Anthony Man-Cho So ($\alpha$-$\beta$ order).<br>
**NeurIPS Workshop OPT 2024** [[arxiv]](https://arxiv.org/abs/2404.08073)
...
- Set Smoothness Unlocks Clarke Hyper-stationarity in Bilevel Optimization <br> He Chen, Jiajin Li, Anthony Man-Cho So.<br>
The 39th Annual Conference on Neural Information Processing Systems (**Neurips 2025, Spotlight**) [[arxiv]](http://arxiv.org/abs/2506.04587)
...
- Fast Algorithms for Stackelberg Prediction Game with Least Squares Loss <br>
Jiali Wang, He Chen, Rujun Jiang, Xudong Li, Zihao Li. <br>
The 38th International Conference on Machine Learning (**ICML 2021**) [[link]](https://proceedings.mlr.press/v139/wang21d.html)
...
- Accelerated Price Adjustment for Fisher Markets with Exact Recovery of Competitive Equilibrium <br>
He  Chen, Chonghe Jiang, Anthony Man-Cho So ($\alpha$-$\beta$ order).<br>
The 21th Conference on Web and Internet Economics (**WINE 2025**) [[arxiv]](http://arxiv.org/abs/2510.07759)
- Computing Competitive Equilibrium for Chores: Linear Convergence and Lightweight Iteration <br>
He  Chen, Chonghe Jiang, Anthony Man-Cho So. <br>
  *Revision* at **Games and Economic Behavior**<br>
The 20th Conference on Web and Internet Economics (**WINE 2024**) [[arxiv]](https://arxiv.org/abs/2410.04036)
